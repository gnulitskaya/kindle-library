...
export const ru: Translations = {
	...
	libraryView: {
		...
		filterWantToRead: 'Хочу прочитать',
		filterRatingLabel: 'Рейтинг:',
		filterRatingAll: 'Любой рейтинг',
		filterRating5: '★★★★★',
		filterRating4: '★★★★☆',
		filterRating3: '★★★☆☆',
		filterRating2: '★★☆☆☆',
		filterRating1: '★☆☆☆☆',
		filterRating0: '☆☆☆☆☆',
		filterCount: (shown: number, total: number) => `Показано ${shown} из ${total}`,
		noFilteredBooks: 'Нет книг по выбранному фильтру.',
